...
namespace PRoConEvents
{
    public class xVotemap : PRoConPluginAPI, IPRoConPluginInterface
    {
        ...
        private Int32 m_iStopVoteTime = 180;
        private Int32 m_iRushVoteStartTime = 600;  // in seconds
        private Int32 m_iCalVoteStartTime = 600;  // in seconds
        private Int32 minimumPlayers = 0;
        private Int32 maximumPlayers = 70;
        ...
        private Dictionary<String, Int32> m_dictVoting = new Dictionary<String, Int32>();     // Player Name, Vote
        ...
        private Int32 m_iCurrPlayerCount = 0;
        ...
        private Int32 m_iNextMapIndex = -1;
        private Int32 m_iCurrMapIndex = -1;
        private Int32 m_iCurrentRoundTime = 0;
        private Players m_players = new Players();

        private List<String> m_listOptsDisplay;

        private Boolean m_boolVotemapEnabled = true;
        private Boolean m_boolVotingStarted = false;
        private Boolean m_boolVotingSystemEnabled = false;
        private Boolean m_boolOnLastRound = true;
        ...
        private Dictionary<String, Int32> myvotes = new Dictionary<String, Int32>();
        ...
        private class Players
        {
            ...
            public Boolean SetVote(String name, Int32 vote)
            {
                foreach (Player p in m_listPlayers)
                {
            ...
            public void Add(String name, Int32 teamId, Int32 squadId)
            {
            ...
            public class Player
            {
                ...
                private Int32 m_TeamId = -1;
                private Int32 m_SquadId = -1;
                private Int32 m_Vote = -1;

                public Player(String name, Int32 teamId, Int32 squadId)
                {
                    m_Name = name;
                    m_TeamId = teamId;
                    m_SquadId = squadId;
            ...
            public class Squad : IComparable<Squad>
            {
                private Int32 m_TeamId = -1;
                private Int32 m_SquadId = -1;
                public Squad(Int32 team, Int32 squad)
                {
                    m_TeamId = team;
                    m_SquadId = squad;
                }
                ...
                public Int32 CompareTo(Squad other)
                {
...
";
        ...
        public void SetPluginVariable(String strVariable, String strValue)
        {
            ...
            else if (strVariable.CompareTo("Randomness") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Number of Vote Options") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Voting Duration (s)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Time between Voting End and Round End (s) (Conquest)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Voting Options Interval (s)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Next Map Display Interval (s)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Votes Threshold (votes)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Voting Start Time from Start of Round (s) (Carrier Assault)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Minimum Players for Start") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
                minimumPlayers = iValue;
            }
            else if (strVariable.CompareTo("Maximum Players for Start") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Banner Yell Duration (s)") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            else if (strVariable.CompareTo("Debug Level") == 0 && Int32.TryParse(strValue, out iValue) == true)
            {
            ...
            {
                Int32 valueAsInt;
                Int32.TryParse(strValue, out valueAsInt);
                if (valueAsInt >= 1)
                {
        ...
        public void OnServerInfo(CServerInfo csiServerInfo)
        {
            ...
            try
            {
                if (this.m_timeServerInfoCheck < DateTime.Now && m_boolVotingSystemEnabled)
                {
                    ...
                    {
                        this.m_iPrevTicket = new Int32[this.m_listCurrTeamScore.Count];
                        for (Int32 i = 0; i < this.m_listCurrTeamScore.Count; i++)
                        {
        ...
        public void OnLevelLoaded(String mapFileName, String Gamemode, Int32 roundsPlayed, Int32 roundsTotal)
        {
            ...
            for (Int32 i = 0; i < m_listPastMaps.Count; i++)
            {
        ...
        private void StartVotingSystem()
        {
            ...
            this.m_dictVoting = new Dictionary<String, Int32>();
            ...
            myvotes = new Dictionary<String, Int32>();
                    ...
                    if (m_iPrevTicket != null)
                    {
                        ...
                        if (m_iPrevTicket[0] != -1)
                        {
                            ...
                            if (m_boolVotingSystemEnabled && !m_boolVotingStarted)
                            {
                                ...
                                Int32 iSecondsTillVoteStart = timeToEnd - this.m_iVotingDuration;
                        ...
                        //try
                        //{
                        for (Int32 i = 0; i < m_iPrevTicket.Length; i++)
                        {
        ...
        private void ProcessChatMessage(String speaker, String message)
        {
            ...
            if (match.Success && message.Length == (m_strHosVotePrefix.Length + 1))
            {
                ...
                {
                    Int32 vote = Convert.ToInt32(match.Groups[m_strHosVotePrefix.Length].Value);

                    if (vote > 0 && vote <= m_listMapOptions.Count)
                    {
                        m_dictVoting.Add(speaker, vote - 1);
                        Boolean success = m_players.SetVote(speaker, vote - 1);
        ...
        private void StartVotingPoll()
        {
            try
            {
                ...
                m_dictVoting = new Dictionary<String, Int32>();
                myvotes = new Dictionary<String, Int32>();
        ...
        private void GenerateMapOptions()
        {
            try
            {
                ...
                try
                {
                    for (Int32 i = tempMaplist.Count - 1; i > -1; i--)
                    {
                ...
                if (iNumOfOptions > 1)
                {
                    List<Int32> selection = new List<Int32>();
                    try
                    {
                    ...
                    selection.Sort(delegate (Int32 map1, Int32 map2)
                    {
                    ...
                    List<Int32> newSelection = new List<Int32>();
                    Int32 k = 0;
                    ...
                    for (Int32 i = 0; i < newSelection.Count; i++)
                    {
        ...
        private List<MaplistEntry> SortMapList(List<MaplistEntry> origMaplist)
        {
            try
            {
                ...
                for (Int32 i = 0; i < m_listPastMaps.Count; i++)
                {
                    for (Int32 j = 0; j < origMaplist.Count; j++)
                    {
        ...
        private void GenerateVoteOptionsDisplay()
        {
            lock (derplock)
            {
                ...
                String strNamenMode = "";
                String strLine = "";
                Int32 iChatMiddle = 15;

                Dictionary<Int32, Int32> myvotescount = new Dictionary<Int32, Int32>();
                foreach (KeyValuePair<String, Int32> kvp in myvotes)
                {
                    ...
                    {
                        for (Int32 i = 1; i < vipvotecount; i++)
                        {
                            myvotescount[kvp.Value]++;
                        }
                    }
                ...
                for (Int32 i = 0; i < m_listGamemodeOptions.Count; i++)
                {
        ...
        {
            Int32[] votes = new Int32[m_listMapOptions.Count];
            Int32 vipvotes = 0;

            foreach (KeyValuePair<String, Int32> kv in m_dictVoting)
            {
                votes[kv.Value]++;
            ...
            for (Int32 i = 0; i < m_listMapOptions.Count; i++)
            {
        ...
        {
            Int32 index = 0;
            for (Int32 i = 0; i < m_listCurrMapList.Count; i++)
            {
        ...
        private void WritePluginConsole(String message, String tag, Int32 level)
        {
        ...
        private Int32 RandomNumber(Int32 min, Int32 max)
        {
            return random.Next(min, max);
        }

        private List<Int32> PseudoRandom(Int32 mid, Int32 max, Int32 randomness)
        {
            ...
            else if (mid < max)
            {
                ...
                for (Int32 i = 0; i < mid; i++)
                {
                    for (Int32 m = 0; m < 100; m++) // attempt to find an unadded map
                    {
                        Int32 testValue = -1;
        ...
        private Int32 FindInTable(Int32 value, Double[] table)
        {
            Int32 result = -1;
            for (Int32 i = 0; i < table.Length; i++)
            {
                if (value < table[i])
                {
                    result = i;
        ...
        private Double[] RandomTable(Int32 mid, Int32 max, Int32 randomness)
        {
        ...
        public Int32 MaxIndex(Int32[] array)
        {
            Int32 maxIndex = -1;
            Int32 maxValue = -1;
            Int32 index = 0;
            List<Int32> draws = new List<Int32>();
        ...
        public Boolean ListsEqual(List<MaplistEntry> a, List<MaplistEntry> b)
        {
            if (a.Count != b.Count)
            {
        ...
        private String GeneratePadding(String text, Double length)
        {
            ...
            Int32 iSpaces = (Int32)Math.Round(numOfSpaces);
            if (iSpaces > 0)
            {
